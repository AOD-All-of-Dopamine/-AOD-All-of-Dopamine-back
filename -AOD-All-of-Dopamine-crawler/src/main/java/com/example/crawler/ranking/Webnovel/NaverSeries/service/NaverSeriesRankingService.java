...
import com.example.crawler.contents.Novel.NaverSeriesNovel.NaverSeriesNovelParser;
 ...
 * - NaverSeriesNovelParser: 유틸리티 메서드 재사용 (productNo, 제목 정리)
    ...
    public void updateDailyRanking() {
        ...
        try {
            ...
            for (String detailUrl : detailUrls) {
                ...
                try {
                    // productNo 추출 (NaverSeriesNovelParser 유틸 재사용)
                    String productNo = NaverSeriesNovelParser.extractQueryParam(detailUrl, "productNo");
