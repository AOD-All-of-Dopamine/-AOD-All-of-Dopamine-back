        ...
        mockMvc.perform(get("/api/my/bookmarks")
                ...
                .andDo(document("interactions-my-bookmarks",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("content[].externalVoteCount").description("TMDB 투표 수 (null 가능)").optional(),
                                fieldWithPath("content[].steamReviewCount").description("Steam 리뷰 수 (null 가능)").optional(),
